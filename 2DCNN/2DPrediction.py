...
config.gpu_options.per_process_gpu_memory_fraction = 0.9                # 限制GPU内存占用率
sess = tf.compat.v1.Session(config=config)
X_data = []
Y_data = []
model_file="./model/9_9vgg2d04.h5"
save_file="./data/Prediction area dataset/DataFor2d/9_9vgg2d04Result.csv"


#predict1
csv1_file="./data/Prediction area dataset/DataFor2d/predict1.csv"
...
while K < 77:
    ...
    while J < 104:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x1_data1[i+(J+j)*125+K*125*112:(i+(J+j)*125+K*125*112)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict2
csv2_file="./data/Prediction area dataset/DataFor2d/predict2.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x2_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict3
csv3_file="./data/Prediction area dataset/DataFor2d/predict3.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x3_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict4
csv4_file="./data/Prediction area dataset/DataFor2d/predict4.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x4_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict5
csv5_file="./data/Prediction area dataset/DataFor2d/predict5.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x5_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict6
csv6_file="./data/Prediction area dataset/DataFor2d/predict6.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x6_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict7
csv7_file="./data/Prediction area dataset/DataFor2d/predict7.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x7_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict8
csv8_file="./data/Prediction area dataset/DataFor2d/predict8.csv"
...
while K < 77:  #125*115*85
    ...
    while J < 107:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x8_data1[i+(J+j)*125+K*125*115:(i+(J+j)*125+K*115*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict9
csv9_file="./data/Prediction area dataset/DataFor2d/predict9.csv"
...
while K < 77:  #125*120*85
    ...
    while J < 112:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x9_data1[i+(J+j)*125+K*125*120:(i+(J+j)*125+K*120*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict10
csv10_file="./data/Prediction area dataset/DataFor2d/predict10.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x10_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict11
csv11_file="./data/Prediction area dataset/DataFor2d/predict11.csv"
...
while K < 77:  #125*121*85
    ...
    while J < 113:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x11_data1[i+(J+j)*125+K*125*121:(i+(J+j)*125+K*121*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict12
csv12_file="./data/Prediction area dataset/DataFor2d/predict12.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x12_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
#predict13
csv13_file="./data/Prediction area dataset/DataFor2d/predict13.csv"
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        ...
        while i < 117:
                j = 0
                while j < 9:
                    X_data.append(x13_data1[i+(J+j)*125+K*125*125:(i+(J+j)*125+K*125*125)+9,:])
                    j = j + 1
                i = i + 1
        J = J + 1
    K = K + 1
...
tmp = predict[0]
char = character[tmp]
conclusion = np.array(predict, dtype=np.int8)
print(conclusion)
prediction_label = np.array(conclusion, dtype=np.int8)


save = pd.DataFrame(prediction_label)
print(save)
print('Export---------------')
# 将预测结果对应到各待估点上
...
while K < 77:  #125*112*85
    ...
    while J < 104:
        i = 0
        while i < 117:
            Frames.append(frames1_1[i+4+(J+4)*125+K*125*112, :])
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames2_1[i+4+(J+4)*125+K*125*125, :])
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames3_1[i+4+(J+4)*125+K*125*125, :])
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames4_1[i+4+(J+4)*125+K*125*125, :])
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames5_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames6_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames7_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*115*85
    ...
    while J < 107:
        i = 0
        while i < 117:
            Frames.append(frames8_1[i+4+(J+4)*125+K*125*115, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*120*85
    ...
    while J < 112:
        i = 0
        while i < 117:
            Frames.append(frames9_1[i+4+(J+4)*125+K*125*120, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames10_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*121*85
    ...
    while J < 113:
        i = 0
        while i < 117:
            Frames.append(frames11_1[i+4+(J+4)*125+K*125*121, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames12_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
...
while K < 77:  #125*125*85
    ...
    while J < 117:
        i = 0
        while i < 117:
            Frames.append(frames13_1[i+4+(J+4)*125+K*125*125, :])  
            i = i + 1
        J = J + 1
    K = K + 1
